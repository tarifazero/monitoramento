...
class CreateRealTimeEntriesCompressionPolicy extends Migration
{
    ...
    public function up()
    {
        DB::statement("ALTER TABLE real_time_entries SET (timescaledb.compress, timescaledb.compress_orderby = 'timestamp', timescaledb.compress_segmentby = 'vehicle_id, route_id');");
    ...
    {
        DB::statement("SELECT remove_compression_policy('real_time_entries');");
